      ...
      <div className="space-y-6">
            ...
            <DropdownMenuContent align="start" className="w-56">
              {mockCountries.map((c) => (
                <DropdownMenuItem key={c.code} asChild>
                  <Link href={`/dashboard/countries/${c.code}/action-items`} className="flex items-center">
                    <img
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-600">Track and manage action items for {country.name}</p>
          </div>
        </div>
